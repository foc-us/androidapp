...
/**
 * Sends a message to the wear app informing it of the current mobile app's state, using the
 * Wearable Messaging Api
 */
public class MobileAppStateResponseService extends BasePlayServicesIntentService {
    ...
    @Override protected byte[] sendMessageToNodes(Intent intent) {
        ...
        if (action != null) {
            ...
            throw new RuntimeException("Attempted to send a null program state");
        }
    }
